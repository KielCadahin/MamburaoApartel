...
<body>
    <form method="post" class="container light-style flex-grow-1 container-p-y">
                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            include "../conn.php";
                                ...
                                if($result->num_rows>0){
                                    while($row = mysqli_fetch_array($result))
                                        ...
                                        echo "<img class='general-profile' src='$imageUrl'>";
                            }
                            ?>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-1" value="Tamangan Jared">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Full Name</label>
                                    <input type="text" class="form-control" value="Tamangan Jared">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">E-mail</label>
                                    <input type="text" class="form-control mb-1" value="jaredtamangan23@gmail.com">
                        ...
                        <div class="tab-pane fade" id="account-info">
                            ...
                            <div class="card-body pb-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="09123987652">
                                </div>
                            </div>
                        </div>
