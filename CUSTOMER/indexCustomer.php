    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="serviceCustomer.php">Services</a></li>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="serviceCustomer.php">Services</a>
            </div>      
        </header>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Name input-->
                                <input class="form-control" id="name" type="text" value="<?php echo $username ?>" data-sb-validations="required" disabled />
                                <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                            </div>
                            <div class="form-group">
                                <!-- Email address input-->
                                <input class="form-control" id="email" type="email" value="<?php echo $email ?>" data-sb-validations="required,email" disabled/>
                                <div class="invalid-feedback" data-sb-feedback="email:required">An email is required.</div>
                                <div class="invalid-feedback" data-sb-feedback="email:email">Email is not valid.</div>
                            </div>
                            <div class="form-group mb-md-0">
                                <!-- Phone number input-->
                                <input class="form-control" id="phone" type="tel" value="<?php echo $phoneNumber ?>" data-sb-validations="required" disabled/>
                    ...
                    <!-- Submit Button-->
                    <div class="text-center"><button style="background-color: #0555de;" class="btn btn-primary btn-xl text-uppercase disabled" id="submitButton" type="submit">Send Message</button></div>
                </form>
            </div>
        </section>
        <!-- Footer-->
