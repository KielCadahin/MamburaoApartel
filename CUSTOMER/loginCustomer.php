...
if(isset($_POST["login"])){
    ...
    //select query 
    $sql = "SELECT * FROM tblcustomer WHERE _username = '$_username' AND _password = '$_password'";
...
<div class="form-container">
   ...
   <div id="divOption">
         <a href="../OWNER/loginOwner.php"><button onclick="owner()" id="owner" class="options">Owner</button></a>
         <a href="loginCustomer.php"><button onclick="customer()" style="background-color:rgb(0, 78, 195); color: white" id="customer" class="options">Customer</button></a>
      </div>
