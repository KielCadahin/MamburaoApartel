                ...
                <?php
                                ...
                                if($result->num_rows>0){
                                    while($row = mysqli_fetch_array($result))
                                        ...
                                        echo "<a href='settingOwner.php'><img src='$imageUrl'></a>";
                            }
                        ?>
                </div>
            </div>
    ...
    <main>
        <div class="container">
            <div class="left">
                ...
                <div class="sidebar">
                    <a href="indexOwner.php" class="menu-item active">
                    ...
                    <a href="settingOwner.php" class="menu-item ">
                ...
                <div class="feeds">
                    <div class="feed">
                        ...
                        ?>
                            ...
                            <div class="info">
                                <h3>Kiel Cadahin</h3>
                                <small>Brgy DOs, 1 MINUTE AGO</small>
                            </div>
